                ...
                {/* <ImageBackground style={{ width: '100%', height: '100%' }} */}
                    ...
                    <FlatList
                        ...
                        renderItem={({ item }) => {
                            ...
                            return <TouchableOpacity style={{ width: '100%', height: 160 ,padding:5}}
                                onPress={() => this.props.navigation.navigate("DreamNote")} >
                                <ImageBackground style={{ borderColor:'transparent',borderRadius:10,borderWidth:1,width: "100%", height: "100%", elevation: 20, borderRadius: 5, resizeMode: 'stretch', alignItems: 'center', justifyContent: 'center' }}
                                    source={require("../image/card_bg.png")}>
                                         <Image style = {{width:70,height:70,position: 'absolute', top: 5, left: 0}} source={require("../image/play.png")}/>
